...
import Vt from "./Vt";
 ...
 function Valid() {
  ...
  const [ideaComplete, setIdeaComplete] = useState(false);
  ...
  function handleIdeaComplete(fr) {
    ...
    setWidths(filled);
    //setReport(buildReport(fr));
    
    setIdeaComplete(true);
    setActiveTab("report");

    // Save to context
    setCompleteIdea(fr.complete_idea);
    setFinalResult(fr);
    setCtxOverall(fr.overall_score);
  ...
  async function handleAnalyse() {
    ...
    try {
      ...
      // Save to context
      setIdea(value);
      setCtxSessionId(data.sessionId);
      setCtxGaps(gapp);
  ...
  function handleMoveToProductDiff() {
    navigate("/product-differentiation");
  }
                      ...
                      <div style={{
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: "14px", color: "#94a3b8" }}>
                            Your idea is validated. Now let's see how you stand out from competitors.
                          </div>
                        </div>
                        <button
                          onClick={handleMoveToProductDiff}
                          style={{
                            padding: "14px 28px",
                            borderRadius: "14px",
                            background: "linear-gradient(135deg, #8b5cf6, #6366f1)",
